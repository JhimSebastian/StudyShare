...
import com.jhimsebastian.studyshare.databinding.ItemLibroAdminBinding
...
class AdaptadorPdfAdmin : RecyclerView.Adapter<AdaptadorPdfAdmin.HolderPdfAdmin> , Filterable{
    ...
    inner class HolderPdfAdmin (itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        val Txt_titulo_tiblo_item = binding.TxtTituloLibroItem
    ...
    override fun onBindViewHolder(holder: HolderPdfAdmin, position: Int) {
        ...
        holder.Txt_titulo_tiblo_item.text = titulo
